"""
Complete Video Downloader Backend - FastAPI + yt-dlp
Working version with automatic downloads
"""
...
app = FastAPI(title="Video Downloader API", version="3.0.0")
...
async def startup_event():
    ...
    logger.info(f"Started {MAX_CONCURRENT_DOWNLOADS} workers on port {PORT}")

@app.get("/")
async def root():
    return {"message": "Video Downloader API", "version": "3.0.0", "status": "running"}
